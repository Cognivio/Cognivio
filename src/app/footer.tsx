    ...
    return (
        <footer className="bg-honey w-screen px-12 py-16">
            <div className="max-w-md mx-auto text-center">
                ...
                {/* Services Section */}
                <div className="mb-8">
                    <h3 className="font-montserrat font-bold text-white text-lg mb-3">Services</h3>
                    <p className="font-montserrat text-gray-900">Our services</p>
                </div>

                {/* About Section */}
                <div className="mb-8">
                    <h3 className="font-montserrat font-bold text-white text-lg mb-3">About</h3>
                    <p className="font-montserrat text-gray-900">About us</p>
                </div>

                {/* Pages Section */}
                <div className="mb-8">
                    <h3 className="font-montserrat font-bold text-white text-lg mb-3">Pages</h3>
                ...
                {/* Contact Section */}
                <div>
                    <h3 className="font-montserrat font-bold text-white text-lg mb-3">Contact Us</h3>
                    <div className="font-montserrat text-gray-900">
